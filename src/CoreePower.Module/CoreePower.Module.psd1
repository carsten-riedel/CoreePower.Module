...
RequiredModules = @(@{ModuleName = 'CoreePower.Lib'; ModuleVersion = '0.0.0.30'; })
...
FunctionsToExport = 'PublishModule', 'PublishModule2', 'UpdateModule', 'UpdateModule2', 
...
AliasesToExport = 'cppm', 'cpum', 'cppm2', 'cpcm', 'cplm', 'cpum2'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://www.powershellgallery.com/packages/CoreePower.Module/0.0.0.53/Content/LICENSE.txt'
