...
AliasesToExport = 'cppm', 'cpum', 'cpcm', 'cpem', 'cplm'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://www.powershellgallery.com/packages/CoreePower.Module/0.0.0.22/Content/LICENSE.txt'
